...
- **Исходники:** `Docs_TG_Platform/web/`
- **Стек:** Next.js 15 (App Router) + React 19 + TypeScript, Feature-Sliced Design (`src/`)
- **Сборка:** статический экспорт (`output: "export"`) → `web/out/`
- **Деплой:** GitHub Pages или любой static host
- **Документация кода:** [`web/ARCHITECTURE.md`](../web/ARCHITECTURE.md), [`web/PRODUCT.md`](../web/PRODUCT.md)
