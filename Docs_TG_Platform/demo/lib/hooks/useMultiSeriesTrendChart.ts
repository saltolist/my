...
import type {
  ...
  TrendChartDotView,
  TrendDotCluster,
} from "@/lib/trendChart/chartTypes";
import {
  TREND_PLOT_BOTTOM,
  TREND_PLOT_TOP,
  buildTrendChartRows,
  collectYValues,
} from "@/lib/trendChart/buildTrendChartRows";
import {
  groupOverlappingTrendDots,
  trendDotKey,
} from "@/lib/trendChart/dotClustering";
import {
  TREND_CHART_WIDTH,
...
import { formatTrendPointPeriod } from "@/lib/trendChart/periodLabels";
