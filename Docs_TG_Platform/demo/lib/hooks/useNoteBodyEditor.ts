...
import { EMBED_MIME, TEXT_DROP_BOUNDARY_FRAC, VIEW_EMBED_DRAG_THRESHOLD_SQ } from "@/components/note/noteBodyEditor/constants";
import {
  hitTestLine,
  ...
  textLineCellMetrics,
} from "@/components/note/noteBodyEditor/dropUtils";
import type { CurrentDropTarget, ImageDropSlot, NoteBodyEditorProps } from "@/components/note/noteBodyEditor/types";
import {
