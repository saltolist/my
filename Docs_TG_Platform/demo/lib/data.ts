...
export const initialChannelProfileConfig: ChannelProfileConfig = {
  core: {
    ...
    audience: "Люди с первыми накоплениями, которые боятся ошибиться и откладывают первый шаг",
    promise: "Помочь разобраться без давления и начать маленькими безопасными шагами",
    angle: "Снижать финансовую тревогу через личный опыт, простые объяснения и спокойный тон",
  },
  voice: {
    tone: "Разговорный, уважительный, без канцелярита, хайпа и ощущения продаж",
    format: "Узнаваемая боль -> простое объяснение -> 2-4 практических шага -> спокойный вывод",
    phrases: "«без паники», «маленький шаг», «сначала безопасность»",
  },
  rules: {
