...
import { shouldClearTrendDotHover, trendDotKey } from "@/lib/trendChart/dotClustering";
import type { TrendChartDotView, TrendSeriesRow } from "@/lib/trendChart/chartTypes";
