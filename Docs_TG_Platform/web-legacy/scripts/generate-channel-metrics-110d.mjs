/**
 * Генерирует src/shared/data/json/channelMetrics110d.json — 110 дней дельт по метрикам канала.
...
const OUT = join(__dirname, "../src/shared/data/json/channelMetrics110d.json");
