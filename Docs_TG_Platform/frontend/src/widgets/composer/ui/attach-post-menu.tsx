...
export function AttachPostMenu({
  attachablePosts,
  currentPostMedia,
  attachedPostMedia,
  onAttachFile,
  ...
  return (
    <>
      ...
      {currentPostMedia.length > 0 ? (
        <>
          <DropdownMenuSeparator />
          <DropdownMenuLabel>Медиа из поста</DropdownMenuLabel>
          <AttachMediaGrid items={currentPostMedia} onSelect={onAttachMedia} />
        </>
      ) : null}
